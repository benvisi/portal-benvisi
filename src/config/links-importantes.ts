...
export const IMPORTANT_RESOURCES: ImportantResource[] = [
  ...
  {
    type: "external_link",
    id: "emissao-nfe-danfe",
    titulo: "Emissão NF-e (DANFE)",
    descricao: "Passo a passo para emitir a Nota Fiscal eletrônica (NF-e) e imprimir o DANFE.",
    externalNote: "O documento é externo ao Portal Benvisi.",
    url: "https://docs.google.com/document/d/1yDdU2oMfYZLnmiazIFjQDXpl586J6VWiauA2ka6TIw0/edit?usp=drivesdk",
    actionLabel: "Abrir guia",
  },
  {
    type: "external_link",
    id: "orientacoes-viagem",
    titulo: "Orientações durante viagem",
    descricao: "Orientações práticas para funcionários em viagem a trabalho.",
    externalNote: "O documento é externo ao Portal Benvisi.",
    url: "https://docs.google.com/document/d/1Sguyr4PXhuQIW1ZVJmUKGINBasxM9y-ta8gbT4aXSts/edit?usp=drivesdk",
    actionLabel: "Abrir guia",
  },
  {
    type: "mobile_app",
